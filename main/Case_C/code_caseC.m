...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
E_power_single_RI_3 = zeros(Imax+1, Jmax+1, Kmax+1);
Brain_SAR_single_RI_3 =zeros(Imax+1, Jmax+1, Kmax+1);
  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
E_power_single_RI_4 = zeros(Imax+1, Jmax+1, Kmax+1);
Brain_SAR_single_RI_4 =zeros(Imax+1, Jmax+1, Kmax+1);
  
E_power_total_RI_4 = zeros(Imax+1, Jmax+1, Kmax+1);
Brain_SAR_total_RI_4 = zeros(Imax+1, Jmax+1, Kmax+1);
